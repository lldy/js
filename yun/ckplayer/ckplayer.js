...
*/
var definition="1";var qrcode="";var prompttext="1";var ckflv_logo="null";var pm_logo="2,0,-150,20";var downspeeds="1";
function ckcpt() {
    var cpt = '';
	if(definition != ""){
	...
	if(qrcode != ""){
		cpt += 'qrcode.swf,2,2,-320,-26,2,1|';
	}
    if(prompttext != ""){
		cpt += 'prompttext.swf,1,2,0,-100,2,0|';
	}
	if(downspeeds != ""){
		cpt += 'downloadspeeds.swf,2,2,-470,-26,2|';
	}
    return cpt;
}
/*
...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
		...
		4、垂直偏移量 
		*/
		logo: ckflv_logo,  // 请在config.php里设置
        //logo: 'cklogo.png',
		//logo: 'null',
        /*
